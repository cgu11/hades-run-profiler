...
sav15_save_data_schema = Struct(
    ...
    "lua_keys" / PrefixedArray(Int32ul, PascalString(Int32ul, "utf8")),
...
sav15_schema = Struct(
    ...
    "checksum" / Padding(4),
    "save_data" / RawCopy(Padded(SAVE_DATA_V15_LENGTH, sav15_save_data_schema)),
    "checksum"
    / Pointer(
        this.checksum_offset,
        Checksum(Int32ul, lambda data: zlib.adler32(data, 1), this.save_data.data),
    ),
)
